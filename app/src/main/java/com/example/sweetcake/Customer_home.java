...
public class Customer_home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView gallery_cus = findViewById(R.id.gallerycus);
        gallery_cus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Customer_home.this, View_gallery.class));
            }
        });
